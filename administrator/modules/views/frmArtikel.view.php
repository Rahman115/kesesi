                            ...
                            <select class="form-control" name="kategori" >
                                <?php foreach ($data["kategori"] as $kategori) { ?>
                                    ...
                                    if (isset($data["artikel"])) {
                                        if ($data["artikel"]->id_kategori == $kategori->id_kategori)
                                            echo 'selected';
                                    }
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea class="form-control editor" name="isi" rows="7" >
                                <?php if(isset($data["artikel"])) echo $data["artikel"]->isi ?>
                            </textarea>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn btn-warning" href="<?php echo PATH; ?>?page=artikel">Tampilkan semua artikel</a>
                        </td>
                    </tr>
                </tbody>
            </table>
