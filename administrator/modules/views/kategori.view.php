                    ...
                    foreach ($data["kategori"] as $kategori) {
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-danger btn-sm" href="<?php echo SITE_URL; ?>?page=kategori&&action=delete&&id=<?php echo $kategori->id_kategori; ?>" onclick="return confirm('Are sure Delete this data?')">Delete</a>
                            </td>
                        </tr>
                        <?php
                        $no++;
