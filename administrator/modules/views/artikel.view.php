                    ...
                    foreach ($data["artikel"] as $artikel) {
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-danger btn-sm" href="<?php echo SITE_URL; ?>?page=artikel&&action=delete&&id=<?php echo $artikel->id_artikel; ?>" onclick="return confirm('Are sure Delete this data?')">Delete</a>
                            </td>
                        </tr>
                        <?php
                        $no++;
