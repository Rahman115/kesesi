<div class="row" >
    <div class="col-lg-12" >
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-book"></i> Konatk</li>
        </ol>
    </div>
</div>
<div class="row" >
            ...
            <table class="table table-hover data-table table-striped tablesorter" >
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a class="btn btn-danger" onclick="return confirm('Are you sure Delete this data?');"
                               href="<?php echo SITE_URL; ?>?page=kontak&&action=delete&&id=<?php echo $kontak->id_kontak; ?>">Delete</a></td>
                    </tr>
                    <?php 
