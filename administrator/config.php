...
//define('PATH', 'http://192.168.113.52/kesesi/administrator/'); // isi path dari website anda
define('PATH', 'https://rahman115.github.io/kesesi/administrator/'); // isi path dari website anda
