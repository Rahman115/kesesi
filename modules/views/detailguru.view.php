        ...
        foreach ($data["guru"] as $guru) {
            ...
            <tr>
                <td style="vertical-align: top; width: 220px; padding-right: 20px">
                    ...
                    <?php } else { ?>
                        <img src="public/images/no_user.jpg" style="width: 200px" >
                    <?php } ?>
                    ...
                    <table class="table">
                        <tbody>
                            ...
                            <tr>
                                <td>NIP</td><td>:</td>
                                <td>
                                    <b><?php echo $guru->nip; ?></b>
                                </td>
                            </tr>
                            <tr>
                                <td>Jenis Kelamin</td><td>:</td>
                                <td>
                                    <b><?php echo $guru->jenis_kelamin; ?></b>
                                </td>
                            </tr>
                            <tr>
                                <td>Status</td><td>:</td>
                                <td>
                                    <b><?php echo $guru->status; ?></b>
                                </td>
                            </tr>
                            <tr>
                                <td>Mata Pelajaran</td><td>:</td>
                                <td>
                                    <b><?php echo $guru->mata_pelajaran; ?></b>
                                </td>
                            </tr>
                            <tr>
                                <td>Tempat Tanggal Lahir</td><td>:</td>
                                <td>
                                    <b><?php echo $guru->tempat_lahir; ?>, <?php echo date('d,m,y', strtotime($guru->tanggal_lahir));  ?></b>
                                </td>
                            </tr>
                            <tr>
                                <td>Alamat</td><td>:</td>
                                <td>
                                    <b><?php echo $guru->alamat; ?></b>
                                </td>
                            </tr>
                        </tbody>
                    </table>
