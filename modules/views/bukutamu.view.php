...
<form role="form" method="post" action="<?php echo POSITION_URL; ?>">
    ...
    <div class="form-group">
        ...
        <input type="url" class="form-control" name="website" id="website" placeholder="http://">
    </div>   
    <div class="form-group">
...
<div class="list">
    <?php foreach ($data["bukutamu"] as $row) { ?> 
        <div class="well">
            <div class="title"><?php echo $row->full_name; ?> | 
                <a href="mailto:<?php echo $row->email; ?>"> 
                    <?php echo $row->email; ?></a> |
                <?php
                if ($row->website) {
                    ?>
                    <a href="<?php echo $row->website; ?>" target="_blank"> <?php $row->website; ?></a>
                <?php } ?>
            </div>
            <div class="text">
