    ...
    <tbody >
        ...
        <tr>
            <td>
                ...
                <?php } else { ?>
                <img src="public/images/siswa/no_user.jpg" style="width: 50px; height: 50px;">
                <?php }  ?>
            </td>
            <td style="vertical-align: middle;"><?php echo $alumni->nis; ?></td>
            <td style="vertical-align: middle;"><b><a href="<?php echo SITE_URL; ?>?page=alumni&&action=detail&&id=<?php echo $alumni->id_siswa; ?>"><?php echo $alumni->nama_lengkap; ?></a></b></td>
