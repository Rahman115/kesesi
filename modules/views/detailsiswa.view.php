...
foreach ($data["siswa"] as $siswa) {
    ?>
    <h2 class="title-top">Detail <?php echo $siswa->status; ?> - 
        ...
        <tbody >
            <tr>
                <td style="vertical-align: top; width: 220px; padding-right: 20px;">
                    ...
                    <?php } else { ?>                
                        <img src="public/images/siswa/no_user.jpg" style="width: 200px;">
                    <?php
                    }
                    ...
                    <table class="table">
                        <tbody>
                            <tr>
                                ...
                                <td style="border-top: 0;"><b><?php echo $siswa->nama_lengkap; ?></b></td>
                            </tr>
                            <tr>
                                <td>NIS</td><td>:</td>
